...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        Launch_Sites_df=filtered_df.groupby(['Launch Site','class']).size().reset_index(name='class count')
        fig=px.pie(Launch_Sites_df,values='class count',names='class',title=f'Successful Launches for {entered_site}')
        return fig
...
def get_scatter(entered_site, slider_range):
    ...
    if entered_site == 'ALL':
        ...
        fig=px.scatter(
            dropdown_scatter,x='Payload Mass (kg)', y='class', 
            title = f'Payload Size Success Correlation for {entered_site}', 
            color='Booster Version Category')
        return fig
